...
export interface NFTPoolInterface extends utils.Interface {
  functions: {
    ...
    "xTokenRewardsShare()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "MAX_BOOST_MULTIPLIER_LIMIT",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "MAX_GLOBAL_MULTIPLIER_LIMIT",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "MAX_LOCK_MULTIPLIER_LIMIT",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "getMultiplierByLockDuration",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
    functionFragment: "getMultiplierSettings",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "harvestPosition",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "xTokenRewardsShare",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export type AddToPositionEvent = TypedEvent<
  [BigNumber, string, BigNumber],
  AddToPositionEventObject
>;
...
export type SetBoostEvent = TypedEvent<
  [BigNumber, BigNumber],
  SetBoostEventObject
>;
...
export type SetBoostMultiplierSettingsEvent = TypedEvent<
  [BigNumber, BigNumber],
  SetBoostMultiplierSettingsEventObject
>;

export type SetBoostMultiplierSettingsEventFilter =
  TypedEventFilter<SetBoostMultiplierSettingsEvent>;
...
export type SetLockMultiplierSettingsEvent = TypedEvent<
  [BigNumber, BigNumber],
  SetLockMultiplierSettingsEventObject
>;

export type SetLockMultiplierSettingsEventFilter =
  TypedEventFilter<SetLockMultiplierSettingsEvent>;
...
export type SetUnlockOperatorEvent = TypedEvent<
  [string, boolean],
  SetUnlockOperatorEventObject
>;

export type SetUnlockOperatorEventFilter =
  TypedEventFilter<SetUnlockOperatorEvent>;

export interface SetXTokenRewardsShareEventObject {
  xTokenRewardsShare: BigNumber;
}
export type SetXTokenRewardsShareEvent = TypedEvent<
  [BigNumber],
  SetXTokenRewardsShareEventObject
>;
...
export interface NFTPool extends BaseContract {
  ...
  functions: {
    ...
    setXTokenRewardsShare(
      xTokenRewardsShare_: PromiseOrValue<BigNumberish>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
    ...
    xTokenRewardsShare(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  filters: {
    ...
    "SetUnlockOperator(address,bool)"(
      operator?: null,
      isAdded?: null
    ): SetUnlockOperatorEventFilter;
    SetUnlockOperator(
      operator?: null,
      isAdded?: null
    ): SetUnlockOperatorEventFilter;

    "SetXTokenRewardsShare(uint256)"(
